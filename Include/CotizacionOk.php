...
// insertar en bd la cotizacion
$insertCotiza = "INSERT INTO SCotizacion(Solicitante, Fecha, Id_Servicio, Telefono, Email, MComunicación, Estatus, Token)VALUES('$Atencion','$FechaC','$Tservicios','$TelefonoC','$EmailC','$Tcontacto','$Estatus','$token')";
$inserta = $conecta->query($insertCotiza);
if($inserta > 0){
  $cotiza.= "<div class='row content-justify-center'>
