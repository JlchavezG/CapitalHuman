      ...
      <div class="col-sm-6 col-md-6 col-lg-6 bg-info py-3 shadow">
        ...
        <div class="container">
          <p class="text-light py-4 justifycado">Somos una empresa  100% mexicana. Enfocada a brindar soluciones integrales para las empresas y/o negocios especializándonos en gestión de información, recursos humanos, paquetería y medios digitales.
            ...
            <br>El servicio y satisfacción de nuestros clientes es lo primordial para nosotros. Capital Human World somos tu mejor opción. 
          </p>
          <div class="row text-center">
            <div class="col">
              <a data-bs-toggle="offcanvas" href="#offcanvasCalidad" class="text-decoration-none" role="button" aria-controls="offcanvasExample"><svg class="bi text-light" width="32" height="32" fill="currentColor">
                ...
                <h5 class="text-light">Calidad</h5>
              </a>
            </div>
            <div class="col">
    ...
    <div class="row banner">
      ...
      <div class="col-sm-8 col-md-8 col-lg-8 text-center">
        <div class="container" id="Rh">
          <h3 class="display-5 py-3" data-aos="flip-down">Nuestras Soluciones en Recursos Humanos</h3>
          <hr>
  ...
  <div class="row py-3">
    ...
    <div class="col-sm-10 col-md-10 col-lg-10 banner2 shadow">
      <div class="container py-3">
        <h3 class="text-center text-light display-6">Capital Human World</h3>
        <hr class="text-light">
        ...
        <div class="modal-body">
          <div class="container text-center">
            ...
            <div class="row">
              ...
              <div class="col">
                <p class="fs-4"><a href="tel:+52 55-55-55-55-55" class="text-decoration-none text-info">55-55-55-55-55</a></p>
              </div>
              <div class="col">
                <p class="fs-4"><a href="tel:+52 55-55-55-55-55" class="text-decoration-none text-info">55-55-55-55-55</a></p>
              </div>
        ...
        <div class="modal-body">
          <div class="container text-center">
            ...
            <div class="row">
              ...
              <div class="col">
                <p class="fs-4"><a href="https://wa.link/gdmtsx" target="_blank" class="text-decoration-none text-info">Escribenos tus dudas</a></p>
              </div>
            </div>
          </div>
        </div>
  ...
  <section id="Digital">
    <div class="row py-3">
      <div class="col-sm-12 col-md-12 col-lg-12 text-center" data-aos="zoom-in">
        <h3 class="display-6 mt-2">Opciones dentro de tu web</h3>
        <hr>
        <div class="row mt-3">
          <div class="col mt-4">
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item list-group-item-action">
              <svg class="bi text-warning" width="20" height="20" role="img" aria-label="Tools">
                <use xlink:href="library/icons/bootstrap-icons.svg#arrow-right-circle-fill" />
              </svg>&nbsp; Diseño Personalizado
            </li>
            <li class="list-group-item list-group-item-action">
              <svg class="bi text-warning" width="20" height="20" role="img" aria-label="Tools">
                <use xlink:href="library/icons/bootstrap-icons.svg#arrow-right-circle-fill" />
              </svg>&nbsp; Contenido adatable Responsive Desing
            </li>
            <li class="list-group-item list-group-item-action">
              <svg class="bi text-warning" width="20" height="20" role="img" aria-label="Tools">
                <use xlink:href="library/icons/bootstrap-icons.svg#arrow-right-circle-fill" />
              </svg>&nbsp; Certificado de Navegación SSL
            </li>
            <li class="list-group-item list-group-item-action">
              <svg class="bi text-warning" width="20" height="20" role="img" aria-label="Tools">
                <use xlink:href="library/icons/bootstrap-icons.svg#arrow-right-circle-fill" />
              </svg>&nbsp; Enlaces a redes sociales
            </li>
            <li class="list-group-item list-group-item-action">
              <svg class="bi text-warning" width="20" height="20" role="img" aria-label="Tools">
                <use xlink:href="library/icons/bootstrap-icons.svg#arrow-right-circle-fill" />
              </svg>&nbsp; whatsapp desde tu web
            </li>
            <li class="list-group-item list-group-item-action">
              <svg class="bi text-warning" width="20" height="20" role="img" aria-label="Tools">
                <use xlink:href="library/icons/bootstrap-icons.svg#arrow-right-circle-fill" />
              </svg>&nbsp; Hosting y dominio gratis por el primer año
            </li>
          </ul>
        </div>
  ...
  <section id="Contacto">
    <div class="row">
      <div class="col-sm-12 col-md-7 col-lg-7 working py-2">
        <h2 class="display-6 text-center text-light py-2">Formulario de Contacto</h2>
        <hr class="text-light">
